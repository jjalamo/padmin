...
Begin VB.Form listadonparte 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Listado por número de Parte de Admisión"
   ClientHeight    =   12000
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14250
   ...
   Begin VB.PictureBox Picture1 
      Height          =   1455
      Left            =   120
      Picture         =   "listadonparte.frx":0000
      ScaleHeight     =   1395
      ScaleWidth      =   11115
      TabIndex        =   3
      TabStop         =   0   'False
   ...
   Begin VB.Label Label1 
      BorderStyle     =   1  'Fixed Single
      Caption         =   "   LISTADO POR NUMERO DE PARTE DE ADMISION"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "listadonparte"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command1_Click()
    Unload listadonparte
...
'    Printer.ForeColor = RGB(100, 100, 100)
    Do While i <= nlineas
        If nuevapag = 1 Then
            Printer.Print " "
            Printer.Print " "
            Printer.Print "Listado de Partes de Admisión, por Número de Parte."
            Printer.Print " "
            Printer.Print Now
            Printer.Print " "
