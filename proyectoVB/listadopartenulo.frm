...
Begin VB.Form listadopartenulo 
   ...
   Begin VB.PictureBox Picture1 
      Height          =   1455
      Left            =   120
      Picture         =   "listadopartenulo.frx":0000
      ScaleHeight     =   1395
      ScaleWidth      =   11115
      TabIndex        =   1
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "listadopartenulo"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command1_Click()
    Unload listadopartenulo
...
'        partefinal = Val(Text2.Text)
        ...
        Do While Not Data3.Recordset.EOF
            If Data3.Recordset("valido") = "no" Then
...
'    Printer.ForeColor = RGB(100, 100, 100)
    Do While i <= nlineas
        If nuevapag = 1 Then
            Printer.Print " "
            Printer.Print " "
            Printer.Print "Listado de Partes de Admisión, Partes Nulos. Desde: "; DTPicker1.Value; "   Hasta: "; DTPicker2.Value
            Printer.Print " "
            Printer.Print Now
            Printer.Print " "
